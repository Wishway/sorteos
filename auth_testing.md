...
```bash
# Test auth endpoint
curl -X GET "https://sorteo-platform-1.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://sorteo-platform-1.preview.emergentagent.com/api/sorteos" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.context.add_cookies([{
    ...
    "domain": "sorteowish.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://sorteo-platform-1.preview.emergentagent.com");
```
